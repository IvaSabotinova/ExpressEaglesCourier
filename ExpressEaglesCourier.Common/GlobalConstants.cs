namespace ExpressEaglesCourier.Common
{
    ...
    {
        public const string SystemName = "ExpressEaglesCourier";
        ...
        public static class EntitiesConstants
        {
            ...
            public const int EmployeeAddressMaxLength = 120;

            public const int EmployeeCityMaxLength = 28;
            ...
            public const int CustomerAddressMaxLength = 120;

            public const int CustomerCityMaxLength = 28;
